...
- **Commercial AI Service:** Powered by the AI Quiz Gen AI gateway (API key required)
...
2. **AI Quiz Gen API Key** - Contact support@human-logic.com for access
3. **PHP 8.0+**
...
1. Download or clone this plugin to `moodle/local/aiquiz_gen`
...
- `mdl_aiquiz_gen_requests` - Generation requests
- `mdl_aiquiz_gen_topics` - Extracted topics
- `mdl_aiquiz_gen_questions` - Generated questions
- `mdl_aiquiz_gen_answers` - Question answers/distractors
- `mdl_aiquiz_gen_settings` - User preferences
- `mdl_aiquiz_gen_logs` - Audit trail

### Key Classes

- `\local_aiquiz_gen\api` - Main API interface
- `\local_aiquiz_gen\content_extractor` - Content parsing
- `\local_aiquiz_gen\topic_analyzer` - Topic extraction
- `\local_aiquiz_gen\question_generator` - Question generation
- `\local_aiquiz_gen\quiz_deployer` - Quiz deployment
- `\local_aiquiz_gen\task\process_generation_queue` - Background processing
