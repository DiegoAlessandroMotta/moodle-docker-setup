 ...
 *
 * @module     local_aiquiz_gen/dashboard
 * @package
...
/* global ApexCharts */
define(['jquery', 'core/ajax', 'local_aiquiz_gen/charts'], function($, Ajax, Charts) {
    'use strict';
    ...
    var Dashboard = {
        ...
        fetchData: function(action) {
            ...
            var methodMap = {
                'acceptancetrend': {methodname: 'local_aiquiz_gen_get_acceptance_trend', args: {courseid: cid}},
                'difficultydist': {methodname: 'local_aiquiz_gen_get_difficulty_distribution', args: {courseid: cid}},
                'bloomsdist': {methodname: 'local_aiquiz_gen_get_blooms_distribution', args: {courseid: cid}},
                'regenbytype': {methodname: 'local_aiquiz_gen_get_regeneration_by_type', args: {courseid: cid}}
            };
        ...
        setupEventListeners: function() {
            ...
            $(document).on('click', '.aiquiz-dismiss-notification, .aiquiz-notification .delete', function() {
                $(this).closest('.notification, .aiquiz-notification').fadeOut(300, function() {
                    $(this).remove();
                });
            });
        },
