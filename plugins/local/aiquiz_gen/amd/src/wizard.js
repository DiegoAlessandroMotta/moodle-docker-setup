 ...
 *
 * @module     local_aiquiz_gen/wizard
 * @package
...
define(['jquery'], function($) {
    ...
    var Wizard = {
        ...
        _validateActivitySource: function() {
            var selectedActivities = document.querySelectorAll('.aiquiz-activity-checkbox:checked');
        ...
        _updateScanWarning: function() {
            ...
            var warningEl = document.getElementById('aiquiz-scan-warning');
            var warningText = document.getElementById('aiquiz-scan-warning-text');
        ...
        _bindDropzone: function() {
            var dropzone = document.getElementById('aiquiz-dropzone');
            var fileInput = document.getElementById('content-files');
            var dropLabel = document.getElementById('aiquiz-dropzone-label');
            ...
            dropzone.addEventListener('dragover', function(e) {
                e.preventDefault();
                e.stopPropagation();
                dropzone.classList.add('aiquiz-dropzone-active');
            });
            dropzone.addEventListener('dragleave', function(e) {
                e.preventDefault();
                e.stopPropagation();
                dropzone.classList.remove('aiquiz-dropzone-active');
            });
        ...
        _bindActivitySelectionControls: function() {
            ...
            if (selectAllBtn) {
                selectAllBtn.addEventListener('click', function() {
                    document.querySelectorAll('.aiquiz-activity-checkbox').forEach(function(cb) {
                        cb.checked = true;
                    });
        ...
        _updateActivityCount: function() {
            var checked = document.querySelectorAll('.aiquiz-activity-checkbox:checked').length;
            var countDisplay = document.getElementById('selected-activities-count');
            var selectedBar = document.querySelector('.aiquiz-activities-selected-bar');
            ...
            document.querySelectorAll('.aiquiz-activity-checkbox').forEach(function(cb) {
                var card = cb.closest('.aiquiz-activity-card');
                if (card) {
                    if (cb.checked) {
            ...
            var warningEl = document.getElementById('aiquiz-activity-warning');
            var warningText = document.getElementById('aiquiz-activity-warning-text');
            if (warningEl && warningText) {
                var scormCount = 0;
                var resourceCount = 0;
                document.querySelectorAll('.aiquiz-activity-checkbox:checked').forEach(function(cb) {
        ...
        _bindDifficultyButtons: function() {
            document.querySelectorAll('.aiquiz-diff-btn input[type="radio"]').forEach(function(radio) {
                radio.addEventListener('change', function() {
                    document.querySelectorAll('.aiquiz-diff-btn').forEach(function(btn) {
        ...
        _bindQuestionTypeDistribution: function() {
            ...
            document.querySelectorAll('.aiquiz-qtype-input').forEach(function(input) {
    ...
    return /** @alias module:local_aiquiz_gen/wizard */ {
