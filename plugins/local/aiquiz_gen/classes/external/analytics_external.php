...
class analytics_external extends external_api {
            ...
            'by_type' => new external_multiple_structure(
                new external_single_structure([
                    ...
                    'count' => new external_value(
                        PARAM_INT,
                        get_string('ws_count_questions_desc', 'local_aiquiz_gen')
                    ),
                    'avg_quality' => new external_value(
                        PARAM_FLOAT,
                        get_string('ws_avg_quality_desc', 'local_aiquiz_gen')
                    ),
                    'approved' => new external_value(
                        PARAM_INT,
                        get_string('ws_approved_questions_desc', 'local_aiquiz_gen')
                    ),
                    'avg_regens' => new external_value(
                        PARAM_FLOAT,
                        get_string('ws_avg_regens_desc', 'local_aiquiz_gen')
                    ),
                ]),
    ...
    public static function get_teacher_confidence() {
        ...
        foreach ($chunks as $i => $chunk) {
            $averages[] = [
                'group' => get_string('ajax_group_label', 'local_aiquiz_gen', ($i + 1)),
