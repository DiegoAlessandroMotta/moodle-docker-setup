...
/**
 * Dashboard external functions for the local_aiquiz_gen plugin.
 *
...
class dashboard_external extends external_api {
    ...
    public static function get_dashboard_stats_parameters() {
        return new external_function_parameters([
            'courseid' => new external_value(PARAM_INT, get_string('param_courseid', 'local_aiquiz_gen'), VALUE_DEFAULT, 0),
        ]);
    }
    ...
    public static function get_question_type_distribution_parameters() {
        return new external_function_parameters([
            'filtercourseid' => new external_value(
                PARAM_INT,
                get_string('ws_filtercourseid_desc', 'local_aiquiz_gen'),
                VALUE_DEFAULT,
                0
            ),
            'courseid' => new external_value(PARAM_INT, get_string('param_courseid', 'local_aiquiz_gen'), VALUE_DEFAULT, 0),
    ...
    public static function get_acceptance_trend_parameters() {
        return new external_function_parameters([
            'limit' => new external_value(
                PARAM_INT,
                get_string('ws_limit_generations_desc', 'local_aiquiz_gen'),
                VALUE_DEFAULT,
                10
            ),
            'courseid' => new external_value(PARAM_INT, get_string('param_courseid', 'local_aiquiz_gen'), VALUE_DEFAULT, 0),
    ...
    public static function get_acceptance_trend($limit = 10, $courseid = 0) {
        ...
        foreach ($requests as $r) {
            $labels[] = get_string('ajax_gen_label', 'local_aiquiz_gen', $i);
    ...
    public static function get_recent_requests_parameters() {
        return new external_function_parameters([
            'limit' => new external_value(
                PARAM_INT,
                get_string('ws_limit_requests_desc', 'local_aiquiz_gen'),
                VALUE_DEFAULT,
                5
            ),
            'courseid' => new external_value(PARAM_INT, get_string('param_courseid', 'local_aiquiz_gen'), VALUE_DEFAULT, 0),
