...
class file_external extends external_api {
     ...
     * the file(s) into the local_aiquiz_gen content file area for the given course.
     *
     ...
     *
     * Deletes all files in the local_aiquiz_gen content area matching the
    ...
    public static function remove_file($courseid, $itemid) {
        ...
        $fs = get_file_storage();
        $files = $fs->get_area_files($context->id, 'local_aiquiz_gen', 'content', $itemid);
