...
class wizard_helper {
    ...
    public static function get_enabled_question_types(): array {
        ...
        if (get_config('local_aiquiz_gen', 'enable_multichoice')) {
            $enabled[] = 'multichoice';
        }
        if (get_config('local_aiquiz_gen', 'enable_truefalse')) {
            $enabled[] = 'truefalse';
        }
        if (get_config('local_aiquiz_gen', 'enable_shortanswer')) {
            $enabled[] = 'shortanswer';
        }
        if (get_config('local_aiquiz_gen', 'enable_essay')) {
            $enabled[] = 'essay';
        }
        if (get_config('local_aiquiz_gen', 'enable_matching')) {
            $enabled[] = 'matching';
        }
