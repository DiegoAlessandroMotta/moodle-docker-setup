...
/**
 * Database upgrade script for the AI Quiz Gen AI Quiz Generator plugin.
 *
...
/**
 * Upgrade the local_aiquiz_gen plugin.
 *
 * @param int $oldversion The old version of the plugin
 * @return bool
 */
function xmldb_local_aiquiz_gen_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2025111300) {
        ...
        upgrade_plugin_savepoint(true, 2025111300, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111303) {
        ...
        $table = new xmldb_table('local_aiquiz_gen_topics');
        $DB->delete_records('local_aiquiz_gen_topics');
        ...
        $table->add_key('requestid', XMLDB_KEY_FOREIGN, ['requestid'], 'local_aiquiz_gen_requests', ['id']);
        $table->add_key('parent_topic_id', XMLDB_KEY_FOREIGN, ['parent_topic_id'], 'local_aiquiz_gen_topics', ['id']);
        $table->add_index('requestid_selected', XMLDB_INDEX_NOTUNIQUE, ['requestid', 'selected']);

        $dbman->create_table($table);

        // Create questions table if it doesn't exist.
        $questionstable = new xmldb_table('local_aiquiz_gen_questions');
        ...
        if (!$dbman->table_exists($questionstable)) {
            ...
            $questionstable->add_key('requestid', XMLDB_KEY_FOREIGN, ['requestid'], 'local_aiquiz_gen_requests', ['id']);
            $questionstable->add_key('topicid', XMLDB_KEY_FOREIGN, ['topicid'], 'local_aiquiz_gen_topics', ['id']);
        ...
        $answerstable = new xmldb_table('local_aiquiz_gen_answers');
        ...
        if (!$dbman->table_exists($answerstable)) {
            ...
            $answerstable->add_key('questionid', XMLDB_KEY_FOREIGN, ['questionid'], 'local_aiquiz_gen_questions', ['id']);
            $answerstable->add_index('questionid_sortorder', XMLDB_INDEX_NOTUNIQUE, ['questionid', 'sortorder']);

            $dbman->create_table($answerstable);
        }

        upgrade_plugin_savepoint(true, 2025111303, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111304) {
        // Add content_hash field to local_aiquiz_gen_requests table for deduplication.
        ...
        upgrade_plugin_savepoint(true, 2025111304, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111305) {
        // Add blooms_distribution field to local_aiquiz_gen_requests table.
        $table = new xmldb_table('local_aiquiz_gen_requests');
        ...
        upgrade_plugin_savepoint(true, 2025111305, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111306) {
        // Create table for URL content extraction.
        $table = new xmldb_table('local_aiquiz_gen_url_content');
        ...
        upgrade_plugin_savepoint(true, 2025111306, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111307) {
        ...
        upgrade_plugin_savepoint(true, 2025111307, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111600) {
        ...
        upgrade_plugin_savepoint(true, 2025111600, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111601) {
        // Add question validation fields.
        $table = new xmldb_table('local_aiquiz_gen_questions');
        ...
        upgrade_plugin_savepoint(true, 2025111601, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111602) {
        // Add cache table for AI responses.
        $table = new xmldb_table('local_aiquiz_gen_cache');
        ...
        $table = new xmldb_table('local_aiquiz_gen_ratelimit_log');
        ...
        upgrade_plugin_savepoint(true, 2025111602, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111603) {
        // Define table local_aiquiz_gen_outcome_map.
        $table = new xmldb_table('local_aiquiz_gen_outcome_map');
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('questionid', XMLDB_KEY_FOREIGN, ['questionid'], 'local_aiquiz_gen_questions', ['id']);
        ...
        // Define table local_aiquiz_gen_calibration.
        $table = new xmldb_table('local_aiquiz_gen_calibration');
        ...
        // Define table local_aiquiz_gen_analytics_cache.
        $table = new xmldb_table('local_aiquiz_gen_analytics_cache');
        ...
        upgrade_plugin_savepoint(true, 2025111603, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111604) {
        // Define table local_aiquiz_gen_reviews.
        $table = new xmldb_table('local_aiquiz_gen_reviews');
        ...
        // Define table local_aiquiz_gen_review_comments.
        $table = new xmldb_table('local_aiquiz_gen_review_comments');
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('reviewid', XMLDB_KEY_FOREIGN, ['reviewid'], 'local_aiquiz_gen_reviews', ['id']);
        $table->add_key('userid', XMLDB_KEY_FOREIGN, ['userid'], 'user', ['id']);
        ...
        // Define table local_aiquiz_gen_review_ratings.
        $table = new xmldb_table('local_aiquiz_gen_review_ratings');
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('fk_rating_review', XMLDB_KEY_FOREIGN, ['reviewid'], 'local_aiquiz_gen_reviews', ['id']);
        $table->add_key('userid', XMLDB_KEY_FOREIGN, ['userid'], 'user', ['id']);
        ...
        // Define table local_aiquiz_gen_revision_issues.
        $table = new xmldb_table('local_aiquiz_gen_revision_issues');
        ...
        // Define table local_aiquiz_gen_revisions.
        $table = new xmldb_table('local_aiquiz_gen_revisions');
        ...
        // Define table local_aiquiz_gen_review_log.
        $table = new xmldb_table('local_aiquiz_gen_review_log');
        ...
        // Define table local_aiquiz_gen_refinements.
        $table = new xmldb_table('local_aiquiz_gen_refinements');
        ...
        // Define table local_aiquiz_gen_refine_suggest.
        $table = new xmldb_table('local_aiquiz_gen_refine_suggest');
        ...
        // Define table local_aiquiz_gen_alternatives.
        $table = new xmldb_table('local_aiquiz_gen_alternatives');
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('original_questionid', XMLDB_KEY_FOREIGN, ['original_questionid'], 'local_aiquiz_gen_questions', ['id']);

        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }

        upgrade_plugin_savepoint(true, 2025111604, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111605) {
        ...
        if (!$dbman->field_exists($table, $field)) {
            ...
            $DB->set_field_select('local_aiquiz_gen_questions', 'requestid', 0, 'requestid IS NULL');
            ...
            // Add foreign key.
            $key = new xmldb_key('requestid', XMLDB_KEY_FOREIGN, ['requestid'], 'local_aiquiz_gen_requests', ['id']);
            $dbman->add_key($table, $key);
        }

        upgrade_plugin_savepoint(true, 2025111605, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111606) {
        ...
        if ($dbman->field_exists($table, $field)) {
            ...
            $key = new xmldb_key('fk_request_id', XMLDB_KEY_FOREIGN, ['request_id'], 'local_aiquiz_gen_requests', ['id']);
        ...
        if ($dbman->field_exists($table, $field)) {
            $key = new xmldb_key('fk_topic_id', XMLDB_KEY_FOREIGN, ['topic_id'], 'local_aiquiz_gen_topics', ['id']);
            if ($dbman->find_key_name($table, $key)) {
                $dbman->drop_key($table, $key);
            }
        ...
        upgrade_plugin_savepoint(true, 2025111606, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111607) {
        ...
        if (!$dbman->field_exists($table, $field)) {
            ...
            $DB->set_field_select('local_aiquiz_gen_questions', 'questiontype', 'multichoice', 'questiontype IS NULL');
            // Now make it NOT NULL.
        ...
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
            // Set default for existing rows.
            $DB->set_field_select('local_aiquiz_gen_questions', 'questiontext', '', 'questiontext IS NULL');
            // Now make it NOT NULL.
        ...
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
            // Set default for existing rows.
            $DB->set_field_select('local_aiquiz_gen_questions', 'questiontextformat', 1, 'questiontextformat IS NULL');
            // Now make it NOT NULL.
        ...
        $key = new xmldb_key('topicid', XMLDB_KEY_FOREIGN, ['topicid'], 'local_aiquiz_gen_topics', ['id']);
        if (!$dbman->find_key_name($table, $key)) {
            $dbman->add_key($table, $key);
        }
        ...
        upgrade_plugin_savepoint(true, 2025111607, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111608) {
        // Add wizard_state table for persistent wizard sessions.
        $table = new xmldb_table('local_aiquiz_gen_wizard_state');
        ...
        $table->add_key('userid', XMLDB_KEY_FOREIGN, ['userid'], 'user', ['id']);
        $table->add_key('courseid', XMLDB_KEY_FOREIGN, ['courseid'], 'course', ['id']);
        $table->add_key('request_id', XMLDB_KEY_FOREIGN, ['request_id'], 'local_aiquiz_gen_requests', ['id']);
        ...
        upgrade_plugin_savepoint(true, 2025111608, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111609) {
        ...
        upgrade_plugin_savepoint(true, 2025111609, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111610) {
        ...
        if (!$dbman->field_exists($table, $field)) {
            ...
            $records = $DB->get_records_sql(
                "SELECT q.id, r.courseid
                   FROM {local_aiquiz_gen_questions} q
                   JOIN {local_aiquiz_gen_requests} r ON r.id = q.requestid
                  WHERE q.courseid = 0"
            );
            foreach ($records as $rec) {
                $DB->set_field('local_aiquiz_gen_questions', 'courseid', $rec->courseid, ['id' => $rec->id]);
            }
        }
        ...
        if (!$dbman->field_exists($table, $field)) {
            ...
            foreach ($records as $rec) {
                $DB->set_field('local_aiquiz_gen_questions', 'userid', $rec->userid, ['id' => $rec->id]);
            }
        }
        ...
        upgrade_plugin_savepoint(true, 2025111610, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111611) {
        // Fix field naming inconsistency in local_aiquiz_gen_answers table.
        // Old installs may have 'question_id' instead of 'questionid'.
        $table = new xmldb_table('local_aiquiz_gen_answers');
        ...
        $key = new xmldb_key('questionid', XMLDB_KEY_FOREIGN, ['questionid'], 'local_aiquiz_gen_questions', ['id']);
        if (!$dbman->find_key_name($table, $key)) {
            $dbman->add_key($table, $key);
        }

        upgrade_plugin_savepoint(true, 2025111611, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025111812) {
        ...
        upgrade_plugin_savepoint(true, 2025111812, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111813) {
        // Fix all remaining NUMBER field LENGTH attributes to prevent validation errors.

        // Fix alignment_score and similarity_score in local_aiquiz_gen_outcome_map.
        $table = new xmldb_table('local_aiquiz_gen_outcome_map');
        ...
        // Fix average_score and discrimination_index in local_aiquiz_gen_calibration.
        $table = new xmldb_table('local_aiquiz_gen_calibration');
        ...
        upgrade_plugin_savepoint(true, 2025111813, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111814) {
        // ITEM 7: Add distribution fields to local_aiquiz_gen_topics table.
        ...
        upgrade_plugin_savepoint(true, 2025111814, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025111815) {
        // ITEM 8: Add plausibility_score field to local_aiquiz_gen_answers table.
        ...
        upgrade_plugin_savepoint(true, 2025111815, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025120201) {
        // Add question_history table for version tracking.
        $table = new xmldb_table('local_aiquiz_gen_qst_history');
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('requestid', XMLDB_KEY_FOREIGN, ['requestid'], 'local_aiquiz_gen_requests', ['id']);
        $table->add_key('topicid', XMLDB_KEY_FOREIGN, ['topicid'], 'local_aiquiz_gen_topics', ['id']);
        $table->add_key('userid', XMLDB_KEY_FOREIGN, ['userid'], 'user', ['id']);
        ...
        upgrade_plugin_savepoint(true, 2025120201, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025120202) {
        // CRITICAL FIX: Remove duplicate columns from local_aiquiz_gen_answers table.
        ...
        upgrade_plugin_savepoint(true, 2025120202, 'local', 'aiquiz_gen');
    }

    if ($oldversion < 2025120203) {
        // Add category_name field to local_aiquiz_gen_requests for custom quiz naming.
        ...
        upgrade_plugin_savepoint(true, 2025120203, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120204) {
        ...
        upgrade_plugin_savepoint(true, 2025120204, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120300) {
        ...
        upgrade_plugin_savepoint(true, 2025120300, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120301) {
        ...
        upgrade_plugin_savepoint(true, 2025120301, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120302) {
        ...
        upgrade_plugin_savepoint(true, 2025120302, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120303) {
        ...
        upgrade_plugin_savepoint(true, 2025120303, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120800) {
        ...
        upgrade_plugin_savepoint(true, 2025120800, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120801) {
        ...
        upgrade_plugin_savepoint(true, 2025120801, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120802) {
        ...
        upgrade_plugin_savepoint(true, 2025120802, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120901) {
        ...
        upgrade_plugin_savepoint(true, 2025120901, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120903) {
        ...
        upgrade_plugin_savepoint(true, 2025120903, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120904) {
        ...
        upgrade_plugin_savepoint(true, 2025120904, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025120905) {
        ...
        upgrade_plugin_savepoint(true, 2025120905, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025121100) {
        ...
        upgrade_plugin_savepoint(true, 2025121100, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025121101) {
        ...
        upgrade_plugin_savepoint(true, 2025121101, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2025121701) {
        ...
        $table = new xmldb_table('local_aiquiz_gen_templates');
        ...
        upgrade_plugin_savepoint(true, 2025121701, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2026020401) {
        ...
        upgrade_plugin_savepoint(true, 2026020401, 'local', 'aiquiz_gen');
    }
    ...
    if ($oldversion < 2026021901) {
        ...
        $renames = [
            'local_aiquiz_gen_url_content'  => 'local_aiquiz_gen_urlcont',
            'local_aiquiz_gen_wizard_state'  => 'local_aiquiz_gen_wizstate',
            'local_aiquiz_gen_ratelimit_log' => 'local_aiquiz_gen_ratelog',
        ];
        ...
        $orphaned = [
            'local_aiquiz_gen_outcome_map',
            'local_aiquiz_gen_calibration',
            'local_aiquiz_gen_analytics_cache',
            'local_aiquiz_gen_review_comments',
            'local_aiquiz_gen_review_ratings',
            'local_aiquiz_gen_revision_issues',
            'local_aiquiz_gen_review_log',
            'local_aiquiz_gen_refinements',
            'local_aiquiz_gen_refine_suggest',
            'local_aiquiz_gen_alternatives',
            'local_aiquiz_gen_qst_history',
        ];
